...
#This script is made to run OpenVR and QQToolkit running side by side when required

signal activated
signal deactivated
signal signal_controller_type_changed; #From QQ
...
## This Part is not needed right now will explore later ##
